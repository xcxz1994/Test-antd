                                ...
                                <Row gutter={ {xs: 8, sm: 16, md: 24, lg: 32} }>
                                    ...
                                    <Col style={{marginTop:30}}>
                                        ...
                                        >
                                            ...
                                            <Row style={{textAlign:"left"}}><Col span={3} style={{marginLeft:10}}><Badge status="error" /></Col><Col span={3} style={{marginLeft:-100}}><p>已通过审批</p></Col></Row><Row style={{textAlign:"left"}}><Col span={3} style={{marginLeft:10}}><Badge status="processing" /></Col><Col span={3} style={{marginLeft:-100}}><p>未完成或被拒绝审批</p></Col></Row>
                                        </Modal>
